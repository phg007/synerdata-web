  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="fixed w-full z-50">
        <div className="border-b border-white/10 bg-[#3C076D]">
      ...
      <main className="flex-1">
          ...
          <div className="container">
            ...
            <div className="mt-8 grid gap-8 md:grid-cols-3 max-w-[1200px] mx-auto">
              {["Ouro Insights", "Diamante Analytics", "Platina Vision"].map(
                (plan, index) => (
                  <Card key={plan} className="relative pt-10">
                    ...
                    <CardHeader className="text-center pb-4">
                      ...
                      <CardDescription>
                        {index === 0 &&
                          "Comece com o essencial para contratações eficazes"}
                        {index === 1 &&
        ...
        >
          <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
            ...
            <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
              Encontre respostas para as dúvidas mais comuns sobre a Synnerdata
              e nossos serviços.
            </p>
          </div>
