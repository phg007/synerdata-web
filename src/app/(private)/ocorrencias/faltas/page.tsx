...
import { getAbsencesByCompany } from "./services/get-absences-by-company";
...
export default function AbsencesPage() {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useQuery<AbsencesObjectResponse[]>({
    queryKey: ["absences", companyId],
    queryFn: () => getAbsencesByCompany(companyId!),
    enabled: !!companyId,
  });
        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Faltas</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
          ...
          {isLoading && absences.length === 0 ? (
            ...
            <div className="p-4 text-center">
              <p className="text-amber-500">
                {"Não foi possível buscar as faltas"}
              </p>
