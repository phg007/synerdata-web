...
import { Loader2, Building, ArrowLeft, User } from "lucide-react";
...
import { CboObjectResponse } from "@/app/(private)/empresas/cbos/interfaces/cbo-interface";
import { getCbosByCompany } from "@/app/(private)/empresas/cbos/services/get-cbos-by-company";
import { CostCenterObjectResponse } from "@/app/(private)/empresas/centros-de-custo/interfaces/cost-center-interface";
import { getCostCentersByCompany } from "@/app/(private)/empresas/centros-de-custo/services/get-cost-centers-by-company";
import { DepartmentObjectResponse } from "@/app/(private)/empresas/setores/interfaces/department-interface";
import { getDepartmentsByCompany } from "@/app/(private)/empresas/setores/services/get-departments-by-company";
import {
  formatCPF,
  formatRG,
  formatPIS,
...
import { RoleObjectResponse } from "@/app/(private)/empresas/funcoes/interfaces/role-interface";
...
export default function UpdateEmployeePage({
  ...
  const { data: employee } = useQuery<EmployeeObjectResponse>({
  ...
  useEffect(() => {
    if (
      ...
      form.reset({
        nome: employee.nome,
        carteiraIdentidade: employee.carteiraIdentidade,
        ...
        peso: employee.peso || 0,
        nomePai: employee.nomePai,
        nomeMae: employee.nomeMae,
        email: employee.email,
        pis: employee.pis,
        ctpsNumero: employee.ctpsNumero,
        ctpsSerie: employee.ctpsSerie,
        certificadoReservista: employee.certificadoReservista,
        regimeContratacao: Object.values(RegimeContratacao).includes(
        ...
        vencimentoExperiencia2:
          formatDate(employee.vencimentoExperiencia2) || "",
        dataExameDemissional: formatDate(employee.dataExameDemissional) || "",
        centroCusto: employee.centroCusto?.id || "",
        grauInstrucao: Object.values(GrauInstrucao).includes(
  ...
  }, [employee, roles, departments, costCenters, cbos, form]);
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Atualize os dados do funcionário da sua empresa
                </p>
              </div>
            </div>
          </div>
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                          ...
                          <div className="space-y-1 leading-none">
                            ...
                            <FormDescription>
                              Marque se o funcionário possui alguma deficiência
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          >
                            ...
                            <SelectContent>
                              <SelectItem value={Escala.SEIS_UM}>
                                6x1
                              </SelectItem>
