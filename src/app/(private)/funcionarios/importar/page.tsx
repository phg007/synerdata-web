                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <p className="text-sm text-blue-700">
                      Muitos erros indicam que os campos estão sendo lidos como
                      números quando deveriam ser texto. No Excel, certifique-se
                      de que as colunas estejam formatadas como{" "}
                  ...
                  <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                    ...
                    <ul className="text-sm text-yellow-700 space-y-1 ml-4">
                      ...
                      <li>
                        • Certifique-se de que números como CPF, PIS, CEP estão
                        formatados como texto
                      </li>
                      <li>
