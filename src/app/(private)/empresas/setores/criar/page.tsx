...
type CreateDepartmentFormData = z.infer<typeof formSchema>;
      ...
      <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Cadastre um novo setor para sua empresa
              </p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Preencha todos os campos obrigatórios para cadastrar o novo setor
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
