    ...
    <div className="container py-8">
      <Card className="max-w-4xl mx-auto bg-white/95 backdrop-blur-sm">
        ...
        <CardContent className="prose prose-lg max-w-none">
          <h2 className="text-2xl font-semibold text-[#2A0F55]">SYNNERDATA4</h2>
          <p>
            ...
            usuários e visitantes do site da empresa SYNNERDATA4, com a
          ...
          <p>
            ...
            preenchimento de cadastro ou acordos comerciais, bem, como mediante
            a interação em nossas plataformas.
          </p>
          ...
          <p>
            ...
            finalidades a possibilidade do Usuário conhecer a oferta de produtos
            e serviços SYNNERDATA4, o fornecimento de informações via formulário
            de contato ou pelo corretor online, identificar os Usuários que
            navegam no site e manter os dados de Usuários atualizados.
          </p>
          ...
          <p>
            ...
            mesmo transfere seus dados a terceiros, comprometendo-se a comunicar
