        ...
        <CardContent className="prose prose-lg max-w-none">
          <div className="space-y-6">
            ...
            <section className="space-y-4">
              ...
              <p>Você poderá solicitar o reembolso nas seguintes condições:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Se o serviço contratado apresentar falhas técnicas comprovadas
                  que não puderam ser solucionadas pelo suporte técnico.
                </li>
                <li>
                  Caso a solicitação de cancelamento seja feita dentro de 7
                  (sete) dias corridos após a contratação, conforme previsto no
                  Código de Defesa do Consumidor para compras online.
                </li>
                <li>
                  Em situações específicas acordadas diretamente com nosso time
                  de suporte.
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>Os reembolsos não serão aplicáveis nas seguintes situações:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
